...
include using an official email address, posting through an official social
media account, or acting as a representative at online or offline events.
...
All complaints will be reviewed and investigated promptly and fairly. Every
report will be handled with respect for the privacy and security of the
reporter.
...
**Consequence:** A private, written warning providing clarification around the
...
**Consequence:** A temporary ban from any sort of interaction with the
community.
